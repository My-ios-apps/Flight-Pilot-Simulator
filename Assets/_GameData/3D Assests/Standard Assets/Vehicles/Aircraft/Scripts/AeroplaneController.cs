    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        private void CaluclateAerodynamicEffect()
        {
            ...
            if (m_Rigidbody.velocity.magnitude > 0)
            {
				...
				newVelocity = Vector3.Lerp(m_Rigidbody.velocity, transform.forward*ForwardSpeed,
					m_AeroFactor*ForwardSpeed*m_AerodynamicEffect*Time.deltaTime);
				//Debug.Log (newVelocity.z);
				float tempSpeed = newVelocity.z * 6;

				//speedText.text = tempSpeed.ToString("F0");
		...
		bool SpeedFlag;
		public float LiftingSpeedValue=0.01f;
        private void CalculateLinearForces()
        {
			...
			var liftPower = m_Lift*zeroLiftFactor*m_AeroFactor;
//			Debug.Log (liftPower);
//			if (SpeedFlag) {
//				liftPower = m_Lift * zeroLiftFactor * m_AeroFactor;
//			} else if (ForwardSpeed>=0.06 ){
//				liftPower = ForwardSpeed*ForwardSpeed*m_Lift*zeroLiftFactor*m_AeroFactor;
//			}
			if (liftPower > LiftingSpeedValue) {
				liftPower = ForwardSpeed*ForwardSpeed*m_Lift*zeroLiftFactor*m_AeroFactor;
			}
